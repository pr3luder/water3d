	...
	public class RenderEngine
	{
		...
		public RenderEngine(GraphicsSystem game)
		{
            ...
            */
            ...
            model = new Model3D(scene, new Vector3(1300.0f, 5.0f, -1300.0f), Matrix.Identity, new Vector3(0.05f, 0.05f, 0.05f), "Models/xwing");
            model.setEffect(xwingEffect);
            model.Mode = "fly";
            

            modelAnim = new Model3DSkinned(scene, new Vector3(1220.0f, 5.0f, -1500.0f), Matrix.Identity, new Vector3(0.005f, 0.005f, 0.005f), "Models/dude", "Take 001");
