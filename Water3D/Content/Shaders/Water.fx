...
// Pixel Shader
// -------------------------------------------------------------
p2a PS_projective(in v2p IN, uniform sampler2D ReflectMap, uniform sampler2D bumpMap, uniform sampler3D Noise, uniform sampler CubeTex,
...
technique TShader
{
    pass P0
    {
        ...
        PixelShader  = compile ps_2_0 PS_projective(ReflectMap, bumpMap, Noise, CubeTex, waveSpeed, noiseSpeed, fadeBias, fadeExp, waterColor, matProjTex);
    }
}